...
Tapas.displayRefData = function(e) {
    ...
    var ref = $(e.target).data('tapasHashedRef');
...
Tapas.ographyToHtml = function(ography) {
    ...
    var wrapperHtml = "<div class='wrapper dialog ography " + ographyType + "'>";
    var html = '';
    var children = ographyData.children();
