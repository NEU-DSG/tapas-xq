<xsl:stylesheet version="1.0"
  ...
  <xsl:template name="toolbox">
    <div id="tapasToolbox">
      ...
      <div id="tapasToolbox-views">
        ...
        <select id="viewBox" onChange="switchThemes(this);">
          <option value="{$view.diplo}" disabled="disabled">choose one:</option>
  ...
  <xd:doc>
    <xd:desc>Insert an HTML note-anchor before each <tt>&lt;note></tt></xd:desc>
  </xd:doc>
  <xsl:template match="tei:note" priority="99">
  ...
  <xsl:template name="javascript">
    ...
    <script type="text/javascript" src="{$filePrefix}/js/jquery-ui/jquery-ui.min.js"/>
